...
public class DodoControls {
	...
	public GameObject PickUpDodo()
	{
		GameStatics.dodo.PlaySound_Catch();
		GameStatics.dodo.transform.parent.GetComponent<NavMeshAgent>().enabled = false;
		return GameStatics.dodo.transform.parent.gameObject;
	}
